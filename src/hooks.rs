...
use crate::HashableString::{FD4ResCap};
use crate::path_processor::file_processor_loop_manual;
...
pub unsafe extern "C" fn get_file_hook(
    ...
    file_processor_loop_manual(dlw_string.string.as_ref().to_string().unwrap());
